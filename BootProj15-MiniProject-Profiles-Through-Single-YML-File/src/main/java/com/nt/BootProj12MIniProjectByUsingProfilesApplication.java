...
public class BootProj12MIniProjectByUsingProfilesApplication {
	...
	public DataSource getc3p0() throws Exception{
		...
		c3p0.setMinPoolSize(Integer.parseInt(env.getRequiredProperty("spring.datasource.c3p0.min-pool-size")));
		c3p0.setMaxPoolSize(Integer.parseInt(env.getRequiredProperty("spring.datasource.c3p0.max-pool-size")));
		return c3p0;
	}
