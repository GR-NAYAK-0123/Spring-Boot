...
@Profile({"uat","prod","raja"})
public class OracleFriendDAOImpl implements IFriendDAO {
	...
	public OracleFriendDAOImpl() {
		System.out.println("OracleFriendDAOImpl: 0-Param constructor");
	}
